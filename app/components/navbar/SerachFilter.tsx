...
const SerachFilter = () => {
  return (
    <div className="flex flex-row flex-grow items-center justify-center sm:justify-between max-w-[850px] sm:h-[66px] border rounded-full mx-auto sm:mb-[30px] lg:mb-[18px] ">
